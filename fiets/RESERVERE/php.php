...
try {
    ...
    if (
        ...
        $sql = $pdo->prepare("INSERT INTO bestellen (voornaam, achternaam, telefoon, adres, huisnummer_toevoeging, email, datum, tijd, id_fiets) 
        VALUES(:voornaam , :achternaam , :telefoon , :adres , :huisnummer_toevoeging , :email , :datum , :tijd, :id)");
