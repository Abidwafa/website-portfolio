...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="../FIETS reserveer/kiezen1.php">Reserveren</a></li>
            <li><a class="active" href="../prijzen/kiezen.php">Prijzen</a></li>
            ...
            <div class="border">
                <div class="main">
                    <div class="fietsentekst">
                        <p style="text-align: center;">Welke fiets wilt u huren * <br>(Voor meer info over de fietsen ga naar informatie)</p>
                    </div>
                    ...
                    <div class="alles">
                        ...
                        <fieldset class="p1">
                            <div class="radio">
                                ...
                                <br>
                                <div>
                                    <a href="../FIETS reserveer/kiezen1.php"><input type="button" id="button" name="button1" value="Reserveren"></a>
                                </div>
                            </div>
                        </fieldset>
